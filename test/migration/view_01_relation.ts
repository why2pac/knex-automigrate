  ...
  migrator('STUDENT_INFORMATION', (view) => {
    ...
    view.as(
      knex('STUDENTS AS S')
        ...
        .leftJoin('PHONES AS HOME_PHONE', 'S.HOME_PHONE_ID', '=', 'HOME_PHONE.PHONE_ID')
        .leftJoin('PHONES AS MOBILE_PHONE', 'S.MOBILE_PHONE_ID', '=', 'MOBILE_PHONE.PHONE_ID')
        .leftJoin('STUDENTS_DETAIL AS SD', 'S.STUDENT_ID', '=', 'SD.STUDENT_ID'),
    );
  }),
];
